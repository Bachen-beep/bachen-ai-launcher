...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\scripts\Build-Installer.ps1" -Version "0.13.1"
```
...
发布前还应检查 `Docs/CleanMachineTestMatrix.md`、`Docs/ReleaseChecklist.md` 和 `Docs/ReleaseSigning.md`。当前 GitHub 预览版说明位于 `Docs/ReleaseNotes-0.13.1-stage2-preview.md`。
